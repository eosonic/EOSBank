...
- 为什么我无法存款？转账失败了。
柚资银行采用业内领先的动态储蓄模型，当柚资银行的资本超过5000.0000EOS之后，柚资银行自动拒绝客户储蓄，任何人无法发送EOS币到合约账户，反之当银行资金池小于5000.0000的时候，储蓄合约自动开启。你将可以发送EOS存储，但请注意，你发送的数量无法使柚资银行的资金池大于5000.0000EOS.
